    ...
    if ($kd_transaksi == "" || $kd_pretransaksi == "" || $barang == "" || $jumlah == "" || $tanggal_keluar == "" || $penempatan == "" || $penerima == "") {
        ...
        if ($jumlah < 1) {
            ...
            if ($sisa['stok_barang'] < $jumlah) {
                ...
                $response = $trans->insert($table, $value, "?page=viewPemakaianBarang");
            }
        }
    }
}
if (isset($_GET['delete'])) {
    ...
    $response = $trans->delete("table_pretransaksi", $where, $id, "?page=addPemakaianBarang");
}
?>
                    ...
                    <form method="post" enctype="multipart/form-data">
                        <div class="card">
                            <div class="au-card-title" style="background-image:url('images/bg-title-01.jpg');">
                                ...
                                <h3>
                                    <i class="fas fa-network-wired"></i>Form Pemakaian Barang
                                </h3>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="card-footer">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <button name="btnAdd" class="btn btn-primary"><i class="fa fa-download"></i> Simpan</button>
                                        <button type="reset" class="btn btn-danger"><i class="fa fa-eraser"></i> Reset</button>
                                    </div>
                                    <!-- tombol kembali akan menempel di kanan -->
                                    <div class="ml-auto">
                                        <a href="?page=viewPemakaianBarang" class="btn btn-danger">
