				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-header d-flex justify-content-between align-items-center">
							<h3>Report Barang Jaringan Terpakai</h3>
							<div>
								<a href="network/exportBarangTerpakai.php" name="export" target="_blank"
									class="btn btn-success">
									<i class="fa fa-file-excel-o"></i> Export Excel
								</a>
								<a href="network/databarangterpakaiexcel.php" target="_blank" class="btn btn-primary">
