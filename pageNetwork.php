...
if ($auth['level'] != 'Network Engineer') {
                ...
                <nav class="navbar-sidebar2">
                    <ul class="list-unstyled navbar__list">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="?page=viewBarang">
                                        <i class="fas fa-network-wired"></i></i>Barang Network </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="?page=viewPemakaianBarang">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <a href="?page=reportStockBarang">
                                    <i class="fas fa-chart-pie" title="Chart Report"></i> Stok Barang</a>
                        </li>
                        <li>
                            <a href="?page=reportPemakaianBarang">
                                <i class="fas fa-chart-line" title="Analytics Report"></i></i>Barang Terpakai</a>
                        </li>
                    </ul>
                    <ul class="list-unstyled navbar__list">
                        <li>
        ...
        <div class="page-container2">
            ...
            switch ($page) {
                ...
                case 'viewDistributor':
                    ...
                    break;
                case 'viewMerek':
                    include "network/viewMerek.php";
                    break;
                case 'reportStockBarang':
                    include "network/viewStockBarang.php";
                    break;
                case 'viewBarangEdit':
                    include "network/viewBarangEdit.php";
                    break;
                case 'viewBarangDetail':
                    include "network/viewBarangDetail.php";
                    break;
                case 'reportPemakaianBarang':
                    include "network/viewBarangTerpakai.php";
                    break;
                case 'viewPemakaianBarang':
                    include "network/viewPemakaianBarang.php";
                    break;
                case 'addPemakaianBarang':
                    include "network/addPemakaianBarang.php";
                    break;
                case 'viewBarang':
                    include "network/viewBarang.php";
                    break;
                case 'addBarang':
