                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="ml-auto">
                                        <a href="?page=viewPemakaianBarangHardware" class="btn btn-danger">
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                    ...
                    <tbody>
                        <?php foreach ($barangs as $brs) { ?>
                            <tr>
                                <td><a
                                        href="pageHardware.php?page=addPemakaianBarangHardware&getItem&id=<?php echo $brs['kd_barang'] ?>"><?php echo $brs['kd_barang'] ?></a>
                                </td>
