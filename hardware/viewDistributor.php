                    ...
                    <div class="au-breadcrumb-content">
                        <div class="au-breadcrumb-left">
                            <ul class="list-unstyled list-inline au-breadcrumb__list">
                                ...
                                <li class="list-inline-item">Data Barang / Data Distributor</li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <form method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="nohp_distributor"
                                        placeholder="Nomor Telepon" value="<?php echo @$editData['no_telp']; ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <table id="example" class="table table-borderless table-striped table-earning">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($dataDis as $ds) {
                                            ?>
                                            <tr>
                                                <td style="text-align:center;"><?= $ds['kd_distributor'] ?></td>
                                                <td><?= $ds['nama_distributor'] ?></td>
                                                <td style="text-align:center;"><?= $ds['no_telp'] ?></td>
                                                <td><?= $ds['alamat'] ?></td>
