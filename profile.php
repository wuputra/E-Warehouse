							...
							<div class="card-body">
								<div class="form-group">
									...
									<input type="text" class="form-control form-control-sm"
										...
										value="<?php echo $auth['kd_user'] ?>" readonly>
								</div>
								<div class="form-group">
									<label for="">Username</label>
									<input type="text" class="form-control form-control-sm"
										value="<?php echo $auth['username'] ?>" readonly>
								</div>
								<div class="form-group">
									<label for="">Nama Pegawai</label>
									<input type="text" class="form-control form-control-sm"
										value="<?php echo $auth['nama_user'] ?>" name="nama">
								</div>
								<div class="form-group">
									<label for="foto_karyawan" class="control-label mb-1">Foto</label>
									<div style="padding-bottom: 15px;">
										<img alt="" width="120" class="img-responsive" id="pict"
											src="img/<?= $auth['foto_user'] ?>">
									</div>
									<input type="file" name="foto" id="gambar" class="form-control-file">
								</div>
								<hr>
								<button name="btnUpdate" class="btn btn-warning"><i class="fa fa-check"></i> Update
									Profil</button>
							</div>
						</div>
					</form>
					...
					<form method="post">
						<div class="card">
							...
							<div class="card-body">
								...
								<hr>
								<button name="ubahPassword" class="btn btn-warning"><i class="fa fa-check"></i> Update
									Password</button>
							</div>
						</div>
					</form>
