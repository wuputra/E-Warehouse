				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-header d-flex justify-content-between align-items-center">
							...
							<div>
								<a href="admin/exportStockBarang.php" name="export" target="_blank"
									class="btn btn-success">
									<i class="fa fa-file-excel-o"></i> Export Excel
								</a>
								<a href="admin/datastockbarangexcel.php" target="_blank" class="btn btn-primary">
									<i class="fa fa-print"></i> Print
								</a>
								<a href="javascript:history.back()" class="btn btn-danger ds">
									<i class="fa fa-repeat"></i></i> Kembali
								</a>
							</div>
						</div>
						<div class="card-body">
