				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-header d-flex justify-content-between align-items-center">
							...
							<div>
								<a href="admin/exportBarangHardwareTerpakai.php" name="export" target="_blank"
									class="btn btn-success">
									<i class="fa fa-file-excel-o"></i> Export Excel
								</a>
								<a href="admin/databaranghardwareterpakaiexcel.php" target="_blank"
									...
									foreach ($dataPre as $ds) {
										...
										<tr>
											...
											<td style="text-align: center;">
												<a href="pageAdmin.php?page=kartuPemakaianBarangHardware&id=<?= $ds['kd_pretransaksi'] ?>"
