<?php
$qb = new lsp();
$dataPre = $qb->select("table_pretransaksi");
...
if (isset($_GET['delete'])) {
    ...
    $response = $qb->delete("table_pretransaksi", "kd_pretransaksi", $_GET['id'], "?page=viewPemakaianBarang");
}
?>
                    ...
                    <div class="au-breadcrumb-content">
                        <div class="au-breadcrumb-left">
                            <ul class="list-unstyled list-inline au-breadcrumb__list">
                                ...
                                <li class="list-inline-item">Data Barang / Pemakaian Barang / Network</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="au-card-title" style="background-image:url('images/bg-title-01.jpg');">
                            ...
                            <h3>
                                <i class="fas fa-network-wired"></i>Data Pemakaian Barang
                            </h3>
                        </div>
                        <div class="card-body">
                            <a href="?page=addPemakaianBarang" class="btn btn-primary"><i
                                        ...
                                        foreach ($dataPre as $ds) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="pageAdmin.php?page=kartuPemakaianBarangJaringan&id=<?= $ds['kd_pretransaksi'] ?>"
                                                            data-toggle="tooltip" data-placement="top" title="Kartu"
                                                            class="btn btn-warning"><i class="fa fa-search"></i></a>
                                                        <a href="?page=viewPemakaianBarangEdit&edit&id=<?= $ds['kd_pretransaksi'] ?>"
                                                            data-toggle="tooltip" data-placement="top" title="Edit"
                                                            class="btn btn-info"><i class="fa fa-edit"></i>
                                                        </a>
                                                        <a href="#" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Delete"
                                                    ...
                                                    <script>
                                                        function confirmDelete(id) {
                                                            swal({
                                                                ...
                                                                if (isConfirm) {
                                                                    window.location.href = "?page=viewPemakaianBarang&delete&id=" + id;
                                                                }
                                                            });
                                                        }
                                                    </script>
