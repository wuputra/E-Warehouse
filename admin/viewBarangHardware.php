...
if (isset($_GET['delete'])) {
    $response = $qb->delete("table_barang_hardware", "kd_barang", $_GET['id'], "?page=viewBarangHardware");
}
?>
                    ...
                    <div class="au-breadcrumb-content">
                        <div class="au-breadcrumb-left">
                            <ul class="list-unstyled list-inline au-breadcrumb__list">
                                ...
                                <li class="list-inline-item">Data Barang / Gudang Barang / Hardware</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="au-card-title" style="background-image:url('images/bg-title-01.jpg');">
                            ...
                            <h3>
                                <i class="fas fa-server"></i></i>Barang Hardware
                            </h3>
                        </div>
                        <div class="card-body">
                            <a href="?page=addBarangHardware" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah
                                Barang</a>
                            </button>
                            <br>
                            <br>
                                        ...
                                        foreach ($dataB as $ds) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <a href="?page=viewBarangHardwareDetail&id=<?php echo $ds['kd_barang'] ?>"
                                                            data-toggle="tooltip" data-placement="top" title="Detail"
                                                            class="btn btn-warning"><i class="fa fa-search"></i></a>
                                                        <a href="?page=viewBarangHardwareEdit&edit&id=<?= $ds['kd_barang'] ?>"
                                            ...
                                            <script>
                                                $('#btdelete<?php echo $no; ?>').click(function (e) {
                                                    ...
                                                    swal({
                                                        ...
                                                        if (isConfirm) {
                                                            window.location.href = "?page=viewBarangHardware&delete&id=<?php echo $ds['kd_barang'] ?>";
                                                        }
                                                    });
                                                });
                                            </script>
