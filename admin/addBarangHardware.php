...
$autokode = $br->autokode("table_barang_hardware", "kd_barang", "BR");
$waktu = date("Y-m-d");
    ...
    if ($kode_barang == " " || $nama_barang == " " || $merek_barang == " " || $distributor == " " || $harga == " " || $stok == " " || $foto == " " || $spesifikasi == " " || $ket == " ") {
        ...
        if ($harga < 0 || $stok < 0 || $harga == 0 || $stok == 0) {
            ...
            if ($response['types'] == "true") {
                ...
                $response = $br->insert($table, $value, "?page=viewBarangHardware");
            }
        }
    }
}
                    ...
                    <form method="post" enctype="multipart/form-data">
                        <div class="card">
                            ...
                            <div class="card-footer d-flex justify-content-between">
                                ...
                                <a href="?page=viewBarangHardware" class="btn btn-danger">
